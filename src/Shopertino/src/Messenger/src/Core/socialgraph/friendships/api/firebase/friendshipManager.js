...
export default class FriendshipManager {
  ...
  fetchFriendships = (userID) => {
    this.inboundFriendshipsUnsubscribe = friendship.subscribeToInboundFriendships(
      userID,
      this.onInboundFriendshipsUpdate,
    );
    this.outboundFriendshipsUnsubscribe = friendship.subscribeToOutboundFriendships(
      userID,
