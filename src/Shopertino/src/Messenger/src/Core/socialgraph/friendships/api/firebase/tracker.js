...
export default class FriendshipTracker {
  ...
  subscribeIfNeeded = () => {
    ...
    if (!state.friends.didSubscribeToFriendships) {
      ...
      this.inboundFriendshipsUnsubscribe = friendshipAPI.subscribeToInboundFriendships(
        userId,
        this.onInboundFriendshipsUpdate,
      );
      this.outboundFriendshipsUnsubscribe = friendshipAPI.subscribeToOutboundFriendships(
        userId,
